...
class _AddState extends ConsumerState<AddPage> {
  ...
  void fetchData() async {
    ...
    categoryList1 = await ApiService.instance.getCategory(userID: user.$id);

    setState(() {
      for (var element in categoryList1) {
                  ...
                  Card(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        enabledBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(30),
                          borderSide: BorderSide(color: Color(0xFF8a5bf5),
                              width: 2),
                        ),
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(30),
                      ...
                      CircleAvatar(
                        ...
                        child: IconButton(
                          onPressed: () async {
                            ...
                            final categoryID = await ApiService.instance.getCategoryID(categoryName: dropdownValue);
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(' Image added', style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 15)),
                        ],
